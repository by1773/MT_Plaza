...
@Component({
  selector: 'app-wc-com-btn',
  templateUrl: './wc-com-btn.component.html',
  styleUrls: ['./wc-com-btn.component.css']
})
export class WcComBtnComponent implements OnInit,OnChanges {
