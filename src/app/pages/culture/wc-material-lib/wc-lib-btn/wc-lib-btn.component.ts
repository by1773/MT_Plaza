...
@Component({
  selector: 'app-wc-lib-btn',
  templateUrl: './wc-lib-btn.component.html',
  styleUrls: ['./wc-lib-btn.component.css']
})
export class WcLibBtnComponent implements OnInit,OnChanges {
