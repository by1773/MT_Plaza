...
@Component({
  selector: 'app-wc-order-btn',
  templateUrl: './wc-order-btn.component.html',
  styleUrls: ['./wc-order-btn.component.css']
})
export class WcOrderBtnComponent implements OnInit,OnChanges {
