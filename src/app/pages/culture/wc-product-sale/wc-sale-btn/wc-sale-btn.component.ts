...
@Component({
  selector: 'app-wc-sale-btn',
  templateUrl: './wc-sale-btn.component.html',
  styleUrls: ['./wc-sale-btn.component.css']
})
export class WcSaleBtnComponent implements OnInit,OnChanges {
