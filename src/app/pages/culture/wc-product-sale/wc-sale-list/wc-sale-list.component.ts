...
@Component({
  selector: 'app-wc-sale-list',
  templateUrl: './wc-sale-list.component.html',
  styleUrls: ['./wc-sale-list.component.css']
})

export class WcSaleListComponent implements OnInit {
public pageTotal=50
  allChecked = false;
  disabledButton = true;
  checkedNumber = 0;
