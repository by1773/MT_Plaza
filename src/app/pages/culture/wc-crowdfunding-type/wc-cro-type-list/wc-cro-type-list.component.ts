...
@Component({
  selector: 'app-wc-cro-type-list',
  templateUrl: './wc-cro-type-list.component.html',
  styleUrls: ['./wc-cro-type-list.component.css']
})

export class WcCroTypeListComponent implements OnInit {
public pageTotal=50
  allChecked = false;
  disabledButton = true;
  checkedNumber = 0;
